...
begin                                 
  timerOnOff.Enabled := (TM <> nil) and (not TM.Active and cbOnTimer.Checked
    and (OnEstimatedTime >= 0) or TM.Active and cbOffTimer.Checked);
